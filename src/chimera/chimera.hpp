...
namespace Chimera {
    ...
    public:
        ...
        /**
         * Get the path to the stock maps folder
         * @return path to the stock maps folder
         */
        const std::filesystem::path get_stock_map_path() noexcept;
    ...
    private:
        ...
        std::filesystem::path p_stock_map_path;
